...
public class AttributeDefinitionRequestDto {
    ...
    public static class AttributeItemDto {
        ...
        /**
         * If provided — finds existing attribute by id and updates it.
         * This allows renaming technicalName without losing linked values.
         * If not provided — upserts by (objectType, category, technicalName).
         */
